...
<head>
    ...
    <link rel="stylesheet" href="tuttiGliEventi21.css" />
    <script src="tuttiGliEventi2.js" defer></script>
    <title>Eventi</title>
</head>
<body>
...
<div id="sezioneRicerca" class="hidden">
    ...
    <article>
        <section>
            <div id="tuttiGliEventi">
                <p>TUTTI GLI EVENTI</p>
            </div>
            <div id="eventiContainer"></div>
        </section>
    </article>
